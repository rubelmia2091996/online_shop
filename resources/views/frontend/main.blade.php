                ...
                <ul class="row">
                    ...
                    <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="product-wrap">
                            <div class="product-img">
                                <span>Sale</span>
                                <img src="thumbnail/{{$product->thumbnail}}" alt="{{$product->tittle}}" width="150px" height="50px">
                                <div class="product-icon flex-style">
                                    <ul>
                            ...
                            <div class="product-content">
                                <h3><a href="{{route('productDetails',$product->slug)}}">{{$product->tittle}}</a></h3>
                                <p class="pull-left">{{$product->attribute->min('regular_price')}}</p>
                                <ul class="pull-right d-flex">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
