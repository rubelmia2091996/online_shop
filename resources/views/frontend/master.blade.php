...
<head>
    ...
    <!-- flaticon.css -->
    <link rel="stylesheet" href="{{ asset('frontendAssets/assets/css/flaticon.css')}}">
    <!-- jquery-ui.css -->
    <link rel="stylesheet" href="{{ asset('frontendAssets/assets/css/jquery-ui.css')}}">
    <!-- metisMenu.min.css -->
    <link rel="stylesheet" href="{{ asset('frontendAssets/assets/css/metisMenu.min.css')}}">
    <!-- swiper.min.css -->
    <link rel="stylesheet" href="{{ asset('frontendAssets/assets/css/swiper.min.css')}}">
    <!-- style css -->
...
<body>
            ...
            <div class="fluid-container">
                <div class="row">
                    ...
                    <div class="col-lg-7 d-none d-lg-block">
                        <nav class="mainmenu">
                            <ul class="d-flex">
                                <li class="{{Route:: is ('frontend')? 'active' : ''}}" ><a href="{{route('frontend')}}">Home</a></li>
                                ...
                                <li class="{{Route:: is ('viewcart')? 'active' : ''}}">
                                    <a href="{{route('viewcart')}}"><i class="fa fa-shopping-cart"></i>Cart</a>
                                </li>
                                {{-- <li>
    ...
    <!-- scrollup.js -->
    <script src="{{ asset('frontendAssets/assets/js/scrollup.js') }}"></script>
    <!-- isotope.pkgd.min.js -->
    <script src="{{ asset('frontendAssets/assets/js/isotope.pkgd.min.js') }}"></script>
    <!-- imagesloaded.pkgd.min.js -->
    <script src="{{ asset('frontendAssets/assets/js/imagesloaded.pkgd.min.js') }}"></script>
    <!-- jquery.zoom.min.js -->
    <script src="{{ asset('frontendAssets/assets/js/jquery.zoom.min.js') }}"></script>
    <!-- countdown.js -->
    <script src="{{ asset('frontendAssets/assets/js/countdown.js') }}"></script>
    <!-- swiper.min.js -->
    <script src="{{ asset('frontendAssets/assets/js/swiper.min.js') }}"></script>
    <!-- metisMenu.min.js -->
    <script src="{{ asset('frontendAssets/assets/js/metisMenu.min.js') }}"></script>
    <!-- mailchimp.js -->
    <script src="{{ asset('frontendAssets/assets/js/mailchimp.js') }}"></script>
    <!-- jquery-ui.min.js -->
    <script src="{{ asset('frontendAssets/assets/js/jquery-ui.min.js') }}"></script>
    <!-- main js -->
