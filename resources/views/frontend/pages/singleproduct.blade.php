                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="product-single-img">
                            @php
                                $gallaryimages = $product->gallery;
                            @endphp
                            <div class="product-active owl-carousel">
                                @foreach ($gallaryimages as $gallaryimage)
                                    <div class="item">
                                    <img src="{{asset('gallery/'.$gallaryimage->image_name)}}" alt="{{$product->tittle}}">
                                    </div>
                                @endforeach
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="product-single-content">
                            ...
                            <div class="rating-wrap fix">
                                <span class="pull-left priceofsize">{{$product->attribute->min('regular_price')}}</span>
                                (<span class="stock">{{$product->attribute->sum('quantity')}}</span>Available)
                            ...
                            <li>
                                ...
                                <input type="radio" name="color" data-product="{{$product->id}}" class="color_id" id="color{{$color->color_id}}" value="{{$color->color_id}}">
                                <label for="color{{$color->id}}">{{ $color->color->color_name }}</label>
                                @endforeach
                            </li>
                            </ul>
                            <ul class="cetagory">
                            ...
                            {{-- <ul class="cetagory">
                                <li>size:</li>
                                @foreach ($product->attribute as $item1)
...
<script>
    $('.color_id').change(function(){
        ...
        $.ajax({
            type:"GET",
            url:"{{url('get/sizecolor-details')}}/" + colorId +"/"+productId,
